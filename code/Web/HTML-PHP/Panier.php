...
.cart-header {
    ...
    padding-bottom: 10px;
    margin-bottom: 20px;
    background: url('music-note-background.png') no-repeat center center; /* Un fond d'éléments de notes de musique */
...
function updateCartCookie(numProduit, newquantite) {
    ...
    if (newquantite > 0) {
        if (productIndex > -1) {
            ...
            cart.push({ numProduit: numProduit, quantite: newquantite });
        }
    } else {
