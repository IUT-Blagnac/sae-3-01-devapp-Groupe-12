...
Lien vers les diagrammes de séquence système : https://github.com/IUT-Blagnac/sae-3-01-devapp-Groupe-12/tree/master/doc/Notre%20client/Diagrammes/Diagramme%20de%20Séquence%20Système[DSS IoT]
